...
export default function InboxPage() {
  ...
  return (
    <main className="min-h-screen bg-[#050816] text-white overflow-hidden">
      <div className="fixed top-0 right-0 w-[500px] h-[500px] bg-cyan-500/8 blur-[180px] rounded-full pointer-events-none" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-5 sm:px-8 py-12 sm:py-16">
        ...
        <div className="space-y-4">
          {emails.map((email, i) => (
            <div
              key={i}
              className="bg-[#081226]/80 backdrop-blur-sm p-5 rounded-2xl border border-[rgba(0,255,255,0.15)]"
            >
              ...
              <button
                className="mt-4 px-4 py-2 rounded-xl bg-gradient-to-r from-[#3B82F6] to-[#00CFFF] text-[#050816] text-sm font-semibold hover:brightness-110 transition-all"
