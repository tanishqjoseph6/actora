...
export const metadata = createPageMetadata({
  title: "Pricing",
  description:
    "Actora pricing: Free Trial with 100 AI credits, Pro at $20/mo, and Team at $69/mo with 5,000 shared credits. Start free for 14 days.",
  path: "/pricing",
  ...
  return (
    <>
      <MarketingPageHero
        ...
        subtitle="Free Trial, Pro ($20/mo), and Team ($69/mo). Billing is workspace-level — invite your team when you're ready."
      />
