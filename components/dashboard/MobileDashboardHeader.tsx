...
export function MobileDashboardHeader({
  ...
  return (
    <header className="lg:hidden sticky top-0 z-30 flex items-center justify-between gap-2 px-4 sm:px-6 py-3 border-b border-white/[0.06] bg-[#0A0A0A]/95 backdrop-blur-xl min-w-0">
      <button
        type="button"
        onClick={onMenuClick}
        className="p-2 rounded-xl border border-white/[0.06] text-[#A1A1AA] hover:text-white hover:border-[#3B82F6]/40 transition-colors shrink-0"
