...
export const COMPARISON_ROWS: ComparisonRow[] = [
  { label: "Storage", free: "5 GB", pro: "50 GB", team: "250 GB", enterprise: "Unlimited" },
  { label: "API Access", free: true, pro: true, team: true, enterprise: true },
  { label: "API calls / month", free: "250", pro: "1,500", team: "5,000", enterprise: "Unlimited" },
  { label: "API rate limit", free: "20 / minute", pro: "300 / minute", team: "500 / minute", enterprise: "1,000 / minute" },
